...
<head>
    ...
    <title>SWAMI PAAN - View Product</title>
    <!-- Bootstrap CSS -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $select = "SELECT products.*, category.category_name FROM products JOIN category ON products.product_category = category.category_id";
